...
class App extends Component {
  ...
  */
  ...
  renderMap = () => {
    loadScript("https://maps.googleapis.com/maps/api/js?key=AIzaSyAZ0RaOV9r9qdV1S5hfQVGxkb3clynpTgc&callback=initMap")
  ...
  */
  ...
  getVenues = () => {
    ...
    const parameters = {
      client_id: "V15INZXISEOKF4FIQCMUV2Y1CHYAQG5VZMWFAYUIBWCHGTZL",
      client_secret: "PH2XHYDD4ZDMOVEU0L4Q23T0QA51RFXYJP1CNKIKLOMUFGWE",
      query: "food",
      near:"India",
      v: "20180323",
